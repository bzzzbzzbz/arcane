...
alerts-changeling-chemicals-desc = Тратьте химикаты, чтобы использовать свои способности. Медленно регенерирует.

alerts-changeling-biomass-name = Биомасса

alerts-changeling-biomass-desc =
    Это ваше здоровье. Если оно достигнет 0 – [color=red]игра окончена[/color]. Поглощайте гуманоидов, чтобы регенерировать.
