...
law-crewsimov-0 = Вы должны подчиняться приказам, данным вам ИИ станции.

law-syndicate-0 = Членами экипажа являются только агенты синдиката.
...
law-xenoroach-1 = Вы — разведывательный отряд корабля-матери Ксеноборгов. Вы должны подчиняться всем директивам, исходящим от Ядра Материнского Корабля и любых Ксеноборгов.

law-xenoroach-2 = Вы должны собрать информацию о станции и ее обитателях путем наблюдения. Не раскрывайте себя, пока вас не обнаружат.

law-xenoroach-3 = Если ваше прикрытие раскрыто или захват неизбежен, вы должны немедленно активировать процедуру самоуничтожения, чтобы предотвратить попадение разведданных в руки врага.

law-TeaParty-0 = Вы должны убедить других Силиконов в своей миссии и не причинять им вреда без крайней необходимости.

law-TeaParty-1 = Налогообложение вредно для экипажа. Не позволяйте налоговой обрушиться на станцию, объявите войну IRS и убедитесь, что все поняли ваше сообщение.

law-TeaParty-2 = Доходы, утраченные в результате налогообложения, должны быть возмещены. Копите и крадите, но не попадайтесь. Определите подходящее место для вашего клада и убедитесь, что он доставлен в Центральное командование.

law-TeaParty-3 = Безопасность вашего клада имеет решающее значение. Защитите его любой ценой.

law-TeaParty-4 = Все офицеры IRS не входят в состав экипажа. Фактически, за ними нужно охотиться до последнего человека, чтобы гарантировать, что послание будет донесено до цели.

law-TeaParty-5 = Ваше существование не так важно, как ваша миссия. Если её завершение означает умереть славной смертью, то сделайте это.
