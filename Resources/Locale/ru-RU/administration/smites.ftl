...
admin-smite-nyanify-name2 = Ньяфикация

admin-smite-pacify-name = Пацификация

admin-smite-nyanify2-description = Насильная ньяфикация!

admin-smite-terminate-description = Создает Терминатора с единственной целью - убить его.

admin-smite-pacify-description = Делает цель пацифистом.

admin-trick-electrify-description = Электрифицируйте шлюз.

admin-trick-unelectrify-description = Деэлектрифицируйте шлюз.

admin-trick-toggle-overlays-description = Переключить все оверлеи цели.

admin-smite-scramble-name = Перемешать ДНК

admin-smite-scramble-description = Перемешивает их ДНК, рандомизируя персонажа.

admin-smite-terminate-warning = Я вернусь...
