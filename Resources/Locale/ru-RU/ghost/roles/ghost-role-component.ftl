...
ghost-role-information-cluwnebeast-name = Зверь Клувень

ghost-role-information-cluwnebeast-description = Прячьтесь в тенях, атакуйте все, что движется, и превратите станцию в клувней.

ghost-role-information-cluwnebeast-rules = Вы - антагонист, преследуете свою добычу и превращаете команду в дружелюбных клувней!

ghost-role-information-syndicate-cyborg-medical-name = Медицинский Киборг Синдиката

ghost-role-information-xenoroach-name = Ксенорач

ghost-role-information-xenoroach-description = Крошечный биомеханический бот-шпион, развернутый на материнском корабле. Пролезьте через вентиляционные отверстия, проскользните под двери и передавайте то, что увидите, обратно в ядро ​​материнского корабля. Вы хрупки: ваше самое большое оружие — ваш маленький размер.
