...
conntrack-resolve-failed-retry = Серверу не удалось проверить ваше соединение, и предыдущий адрес для вашей учетной записи не указан. Пожалуйста, переподключитесь через некоторое время.
